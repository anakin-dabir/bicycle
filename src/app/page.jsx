...
export default function Home() {
  return (
    <>
      <div className='w-screen h-72 md:h-[600px] lg:h-[calc(100vh-150px)] -mt-1 relative'>
        <Image src='/bg.png' fill={true} priority className='w-screen object-cover object-center' />
